...
@push('css')
    <style>
        ...
        .retur-table tbody tr:last-child {
            display: none;
        }
...
@section('breadcrumb')
    @parent
    <li class="breadcrumb-item active">Return Transcation</li>
@endsection
...
@section('content')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-5">
                                    <div class="input-group mb-3">
                                        <input type="hidden" name="id_retur" id="id_retur" value="{{ $id_retur }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <form action="{{ route('retur.store') }}" class="form-retur" method="post">
                                    ...
                                    <div class="form-group row">
                                        <label for="payrp" class="col-lg-2 control-label">Pay</label>
                                        <div class="col-lg-8">
    ...
    @includeIf('retur_detail.product')
@endsection
...
@push('scripts')
    <script>
        ...
        // Menambah Product ke Retur Detail
        function addProduct() {
            $.post('{{ route('retur_detail.store') }}', $('.form-product').serialize())
                .done(response => {
                    $('#product_code').focus()
                    table.ajax.reload()
                })
        ...
        function loadForm(discount = 0) {
            ...
            $.get(`{{ url('/retur_detail/loadform') }}/${discount}/${$('.total_price').text()}`)
                .done(response => {
