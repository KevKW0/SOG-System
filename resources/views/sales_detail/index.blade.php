...
@section('breadcrumb')
    @parent
    <li class="breadcrumb-item active">Sales Transcation</li>
@endsection
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <form action="{{ route('sales.store') }}" class="form-sales" method="post">
                                    @csrf
    ...
    <script>
        ...
        $(function() {
            table = $('.sales-table').DataTable({
                    ...
                    autoWidth: false,
                    ajax: {
                        url: '{{ route('sales_detail.data', $id_sales) }}',
                    },
                    columns: [{
                            data: 'DT_RowIndex',
                            searchable: false,
        ...
        // Menambah Product ke Sales Detail
        function addProduct() {
            $.post('{{ route('sales_detail.store') }}', $('.form-product').serialize())
                .done(response => {
                    $('#product_code').focus()
                    table.ajax.reload()
                })
        ...
        function loadForm(discount = 0) {
            ...
            $.get(`{{ url('/sales_detail/loadform') }}/${discount}/${$('.total_price').text()}`)
                .done(response => {
