    ...
    <table class="data" width="100%">
        ...
        <tfoot>
            <tr>
                ...
                <td class="text-right"><b>{{ money_format($sales->total_price) }}</b></td>
            </tr>
            <tr>
                <td colspan="4" class="text-right"><b>Discount</b></td>
                <td class="text-right"><b>{{ money_format($sales->discount) }}%</b></td>
            </tr>
            <tr>
                <td colspan="4" class="text-right"><b>Grandtotal</b></td>
                <td class="text-right"><b>{{ money_format($sales->pay) }}</b></td>
            </tr>
        </tfoot>
    </table>
    <br><br>
